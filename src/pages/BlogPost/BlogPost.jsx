        ...
        <div>
            ...
            <section className='px-20 mt-16'>
                ...
                <div className='px-52 mt-16'>
                    ...
                    <h1 style={{ letterSpacing: '-2px', lineHeight: '48px' }} className=' text-4xl mt-12 font-bold font-[Sen] text-[#232536] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</h1>
                    <p className='text-base text-[Inter] mt-4 text-[#6D6E76]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Non blandit massa enim nec. Scelerisque viverra mauris in aliquam sem. At risus viverra adipiscing at in tellus. Sociis natoque penatibus et magnis dis parturient montes. Ridiculus mus mauris vitae ultricies leo. Neque egestas congue quisque egestas diam. Risus in hendrerit gravida rutrum quisque non.</p>


                    <ul className='mt-12'>
                        <li className=' text-2xl font-bold font-[Sen] text-[#161722] opacity-70'>Lorem ipsum dolor sit amet</li>
                        <li className=' text-2xl font-bold font-[Sen] text-[#161722] opacity-70'>Non blandit massa enim nec scelerisque</li>
                        <li className=' text-2xl font-bold font-[Sen] text-[#161722] opacity-70'>Neque egestas congue quisque egestas</li>
            ...
            <section className='px-20 mb-32'>
                <h1 className=' text-4xl font-bold font-[Sen] text-[#232536] mt-32 mb-16 '>What to read next</h1>
